...
if (document.querySelector('.home_video')) {
    ...
    window.addEventListener('resize', () => {
        let my_video_container = document.querySelector('.my_video_container')
        my_video_container.style.height = (my_video_container.offsetWidth * 0.52) + 'px';
    })
    let my_video_container = document.querySelector('.my_video_container')
    my_video_container.style.height = (my_video_container.offsetWidth * 0.52) + 'px';
    /*----------show-block-button-------*/
...
//для всех textarea увеличивать высоту относительно контента ввода
    ...
    /*----Validate--*/
    const input_1 = document.querySelector('#contact_us_input_1')
    const input_2 = document.querySelector('#contact_us_input_2')
    ...
    inputs_[0].addEventListener('focusout', () => {
        if (!/^[a-z ,.'-]+$/i.test(input_1.value)) {
            inputs_[0].classList.add('validate1')
        } else {
            inputs_[0].classList.remove('validate1')
        }
    })
    inputs_[1].addEventListener('focusout', () => {
        if (email_test(input_2)) {
            inputs_[1].classList.add('validate2')
        } else {
            inputs_[1].classList.remove('validate2')
        }
    })
