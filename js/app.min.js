...
header__icon2.addEventListener('mouseenter', () => {
    ...
    header__icon2.addEventListener("mousemove", e => {
        const lengthY = e.pageY - header_logo.offsetHeight / 2 - header_logo.getBoundingClientRect().top - pageYOffset;
        const lengthX = e.pageX - header_logo.offsetWidth / 2 - header_logo.getBoundingClientRect().left;
