...
function transform3dInput(inputclas, clas, elHeight = null) {
    ...
    transform3dA.forEach((el) => {
        ...
        el.querySelector('.' + inputclas).addEventListener('click',()=>{
...
if (document.querySelector('.home_video')) {
    ...
    rotate_container.forEach((el) => {
        ...
        el.addEventListener('mouseenter', (e) => {
            ...
            imgel.style.setProperty('rotate_x', `${lengthX/window.innerWidth*100}vw`)
            imgel.style.setProperty('rotate_y', `${lengthY/window.innerHeight*100}vh`)
            setTimeout(() => {
                if (mouseIn) {
